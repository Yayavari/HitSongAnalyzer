...
- **Hit Formula Score** — top scoring songs combine high danceability (0.3 weight), energy (0.25), valence (0.2), loudness (0.15), and tempo (0.1)
- **Formula ≠ Popularity** — high audio scores don't guarantee chart success, suggesting cultural and marketing factors matter too

## Dashboard Pages
1. **Hit Overview** — Genre distribution, audio feature trends, scatter of popularity vs danceability
2. **Decade Deep Dive** — How energy, valence, danceability, and tempo shifted decade by decade; genre rise & fall over time
...
## Author
Yaya | Systems Engineer @ Infosys | Aspiring Data Analyst
[GitHub](https://github.com/Yayavari) | [LinkedIn](#)
